...
// for the frontend (HayloAuth, Supabase, Stripe public keys, etc).
//
// This matches the rewrite in vercel.json:
//   { "source": "/env.js", "destination": "/api/env.js" }
//
// When the browser loads /env.js, Vercel rewrites it to this file.
...
export default async function handler(req) {
  ...
  const cfg = {
    ...
    // Stripe public config for frontend
